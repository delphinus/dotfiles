  ...
  -- Colorscheme {{{
  {
    ...
    config = function()
      ...
      nvim_create_augroups{
        nord_overrides = {
          {'ColorScheme', 'nord', 'lua nord_overrides()'},
        },
      }
    end,
  },
