-- Dev env for obsidian-kensaku.nvim + fzf-lua integration test.
-- Usage:
--   NVIM_APPNAME=nvim-dev/kensaku-fzf-lua nvim
--
-- Keymaps:
--   <Leader>oq  :Obsidian quick_kensaku   (live filename — planned v3.5, currently errors)
--   <Leader>os  :Obsidian kensaku         (live grep — planned v3.5, currently errors)
--   <Leader>oS  :Obsidian kensaku sabu    (one-shot grep via obsidian.picker.pick)
--
-- fzf-lua is fetched fresh by lazy.nvim (no local copy under ~/.local/share/nvim/lazy).
...
require("lazy").setup {
  ...
  {
    "ibhagwan/fzf-lua",
    -- No local dir; lazy.nvim will clone to this dev env's own data dir.
    opts = {},
  },
  {
    "delphinus/luamigemo",
  ...
  },
  {
    ...
    ft = "markdown",
    cmd = { "Obsidian" },
    dependencies = { "delphinus/obsidian-kensaku.nvim", "ibhagwan/fzf-lua" },
    opts = {
